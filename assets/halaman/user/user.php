						...
						<input type="hidden" name="idGuru" id="idGuru">
							...
							<div class="form-group">
								<div class="col-sm-offset-4 col-sm-8">
								  <button name="btnSimpan" id="btnSimpan" type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span>  Simpan</button>
...
<script type="text/javascript" src="halaman/user/user.js"></script>